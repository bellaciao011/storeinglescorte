...
import { ChevronLeft, Heart, Share2, Star, CheckCircle, ShieldCheck, Truck, RotateCcw, Zap } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F8F8F8] font-sans">
      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-4">
          ...
          {/* Image */}
          <div className="relative bg-gray-50 flex items-center justify-center p-8" style={{ minHeight: 280 }}>
            <motion.img
          ...
          <div className="px-5 py-5">
            ...
            {product.color && (
              <div className="mb-5">
                <p className="text-xs font-bold text-gray-700 mb-1">Color: <span className="font-normal text-gray-500">{product.color}</span></p>
              </div>
            )}
            ...
            <motion.button
              whileTap={{ scale: 0.98 }}
              onClick={handleBuy}
              className="w-full py-4 rounded-xl font-black text-white text-base mb-3 transition-all"
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 mb-4">
          ...
          <div className="space-y-3">
            {[
              { title: "ECI Care — Protección accidentes", sub: "Protege tu producto contra daños accidentales y averías", price: "desde 2,99 €/mes" },
            ...
            <div className="grid grid-cols-2 gap-3">
              {related.map((p) => {
                ...
                return (
                  <button
                    key={p.id}
                    onClick={() => setLocation(`/producto/${p.id}`)}
                    className="bg-white rounded-xl overflow-hidden shadow-sm text-left"
                  >
                    <div className="bg-gray-50 flex items-center justify-center p-4" style={{ minHeight: 100 }}>
                      <img src={p.img} alt={p.shortName} className="max-h-20 w-auto object-contain"
                        onError={(e) => { (e.target as HTMLImageElement).src = "/assets/kit-basico.png"; }} />
                    </div>
                    <div className="p-3">
