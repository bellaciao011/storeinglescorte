...
export default function Checkout() {
  ...
  const orderBumps = [
    { id: "bump50", label: "+50 sobres · ~350 cromos", desc: "Descuento de preventa con envío gratis en México.", price: 449, oldPrice: 899, img: "/assets/kit-iniciante.png", badge: null },
    { id: "bump100", label: "+100 sobres · ~700 cromos", desc: "El equilibrio preferido de los coleccionistas — preventa exclusiva.", price: 799, oldPrice: 1799, img: "/assets/kit-campeao.png", badge: { text: "MÁS VENDIDO", cls: "bg-red-600 text-white" } },
    { id: "bump250", label: "+250 sobres · ~1,750 cromos", desc: "Máximo descuento en este lote promocional.", price: 1499, oldPrice: 3999, img: "/assets/kit-colecionador.png", badge: { text: "ÚLTIMAS UNIDADES", cls: "bg-amber-400 text-gray-900" } },
  ];
