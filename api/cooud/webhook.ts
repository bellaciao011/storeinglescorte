    ...
    if (event.type === "order.paid") {
      ...
      await sendToUtmify({
        ...
        trackingParameters: {
          src:          paid?.src          ?? null,
          sck:          paid?.sck          ?? null,
          utm_source:   paid?.utm_source   ?? null,
          utm_campaign: paid?.utm_campaign ?? null,
          utm_medium:   paid?.utm_medium   ?? null,
          utm_content:  paid?.utm_content  ?? null,
          utm_term:     paid?.utm_term     ?? null,
          fbclid:       paid?.fbclid       ?? null,
          gclid:        paid?.gclid        ?? null,
          ttclid:       paid?.ttclid       ?? null,
        },
        commission: {
